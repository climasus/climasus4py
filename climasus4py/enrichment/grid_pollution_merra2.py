...
def sus_grid_pollution_merra2(
    ...
    # Antes de qualquer download: sem engine NetCDF a leitura falharia no
    # FIM, depois de gastar o arquivo, com uma mensagem do proprio xarray
    # apontando a documentacao dele. Ver M40.
